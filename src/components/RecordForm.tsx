...
export default function RecordForm({
  ...
  useEffect(() => {
    ...
    const base = {
      ...
      Registrado_por: get(initialData, "Registrado_por") || localStorage.getItem("bravo_operator_name") || userEmail || "Familia Bravo",
    ...
    if (type === "gasto") {
      setFormData({
        ...
        Categoría: get(initialData, "Categoría", "Categoria"),
        Subcategoría: get(initialData, "Subcategoría", "Subcategoria"),
        Monto_MXN: numberFrom(get(initialData, "Monto_MXN")),
        Método_pago: get(initialData, "Método_pago", "Metodo_pago"),
        Camión: get(initialData, "Camión", "Camion") || (localStorage.getItem("bravo_default_truck") || ""),
    ...
    if (type === "viaje") {
      setFormData({
        ...
        Kilómetros: numberFrom(get(initialData, "Kilómetros", "Kilometros")),
        Camión: get(initialData, "Camión", "Camion") || (localStorage.getItem("bravo_default_truck") || ""),
        Chofer: get(initialData, "Chofer"),
